<template>
  <el-row :gutter="40">
    <el-row class="common-right-weizhi">
      ...
      <el-col :span="12" style="padding:20px" v-for="item in ZTWY" :key="item.id">
        <el-row :span="11">
    ...
    <el-row v-for="item in list" :key="item.id" class="common-right-info">
      <router-link
        :to="{ path: '/common/details2', query: { ...$route.query, newId: item.id, siteId: item.siteId }}"
      >
        <el-row>
          <el-col :xs="6" :md="6">
            <img :src="item.image" style="width: 180px;height: 120px;" />1414
          </el-col>
